//Prolly don't need but w/e
function userLogin(username) {
    var gotohere = username + ".html";
    location.href = gotohere;
}

//ARGS NEED TO BE SENT AS JSON NOT JUST RAW DATA UGHGHGH
function stopWasher() {
    var setting = "1";
...
//A hack solution for the popup cycle create box
...
//uses cookies to save cycles, see other js files. Only retains a max of 3 additional cycles per user.
